...
没有特别的原因，只是觉得——如果第一场雪没有人踩过，它会不会太寂寞了。`,
  ...
  /* ─── friend-u3-world 云端漫步 (流云) ─── */
  {
    id: 'entry-f3-1',
    worldId: 'friend-u3-world',
    userId: 'u3',
    title: '飞机上的日落',
    content: `坐晚班机，正好遇见了一场三万英尺高空的日落。\n\n云层变成了粉红色的海，太阳把每朵云都镶了一圈金边。\n机舱里的灯调暗了，大家要么睡了要么在看电影。\n\n只有我趴在窗边，觉得这一刻太珍贵了。`,
    mode: 'normal',
    status: 'published',
    emotion: '感动',
    emotionHue: 320,
  ...
  },
  {
    ...
    userId: 'u3',
    title: '云的名字',
    content: `今天在学云的类型。\n\n卷积云、高积云、层云、积雨云……每一种都有自己的形状和脾气。\n\n最喜欢的还是积云——那种又大又蓬松的，像刚出炉的面包。\n小时候叫它们"棉花糖云"，现在知道学名了，但还是觉得棉花糖比较准确。`,
    mode: 'normal',
    status: 'published',
    emotion: '开心',
    emotionHue: 45,
